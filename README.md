...
*   int Create(int priority, void (\*function)())
    ...
    _Comment_: If newly created tasks need to receive configuration parameters, these generally need to be provided via message passing. However, if the configuration value is a primitive type, implementing a shortcut via another argument to Create() and function() is permissible.
...
*   void Destroy()
    ...
    _Comment_: This functionality is not necessarily needed. Re-using resources is complicated. This will be discussed in class.
